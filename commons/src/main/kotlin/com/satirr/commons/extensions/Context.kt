...
import com.satirr.commons.helpers.AppLockManager
import com.satirr.commons.helpers.BaseConfig
import com.satirr.commons.helpers.ContactsHelper
import com.satirr.commons.helpers.DAY_SECONDS
import com.satirr.commons.helpers.FONT_SIZE_LARGE
import com.satirr.commons.helpers.FONT_SIZE_MEDIUM
import com.satirr.commons.helpers.FONT_SIZE_SMALL
import com.satirr.commons.helpers.FRIDAY_BIT
import com.satirr.commons.helpers.HOUR_SECONDS
import com.satirr.commons.helpers.KEY_MAILTO
import com.satirr.commons.helpers.MINUTE_SECONDS
import com.satirr.commons.helpers.MONDAY_BIT
import com.satirr.commons.helpers.MONTH_SECONDS
import com.satirr.commons.helpers.MyContactsContentProvider
import com.satirr.commons.helpers.PERMISSION_ACCESS_COARSE_LOCATION
import com.satirr.commons.helpers.PERMISSION_ACCESS_FINE_LOCATION
import com.satirr.commons.helpers.PERMISSION_CALL_PHONE
import com.satirr.commons.helpers.PERMISSION_CAMERA
import com.satirr.commons.helpers.PERMISSION_GET_ACCOUNTS
import com.satirr.commons.helpers.PERMISSION_MEDIA_LOCATION
import com.satirr.commons.helpers.PERMISSION_POST_NOTIFICATIONS
import com.satirr.commons.helpers.PERMISSION_READ_CALENDAR
import com.satirr.commons.helpers.PERMISSION_READ_CALL_LOG
import com.satirr.commons.helpers.PERMISSION_READ_CONTACTS
import com.satirr.commons.helpers.PERMISSION_READ_MEDIA_AUDIO
import com.satirr.commons.helpers.PERMISSION_READ_MEDIA_IMAGES
import com.satirr.commons.helpers.PERMISSION_READ_MEDIA_VIDEO
import com.satirr.commons.helpers.PERMISSION_READ_MEDIA_VISUAL_USER_SELECTED
import com.satirr.commons.helpers.PERMISSION_READ_PHONE_STATE
import com.satirr.commons.helpers.PERMISSION_READ_SMS
import com.satirr.commons.helpers.PERMISSION_READ_STORAGE
import com.satirr.commons.helpers.PERMISSION_READ_SYNC_SETTINGS
import com.satirr.commons.helpers.PERMISSION_RECORD_AUDIO
import com.satirr.commons.helpers.PERMISSION_SEND_SMS
import com.satirr.commons.helpers.PERMISSION_WRITE_CALENDAR
import com.satirr.commons.helpers.PERMISSION_WRITE_CALL_LOG
import com.satirr.commons.helpers.PERMISSION_WRITE_CONTACTS
import com.satirr.commons.helpers.PERMISSION_WRITE_STORAGE
import com.satirr.commons.helpers.PREFS_KEY
import com.satirr.commons.helpers.SATURDAY_BIT
import com.satirr.commons.helpers.SUNDAY_BIT
import com.satirr.commons.helpers.THURSDAY_BIT
import com.satirr.commons.helpers.TIME_FORMAT_12
import com.satirr.commons.helpers.TIME_FORMAT_12_WITH_SECS
import com.satirr.commons.helpers.TIME_FORMAT_24
import com.satirr.commons.helpers.TIME_FORMAT_24_WITH_SECS
import com.satirr.commons.helpers.TUESDAY_BIT
import com.satirr.commons.helpers.WEDNESDAY_BIT
import com.satirr.commons.helpers.WEEK_SECONDS
import com.satirr.commons.helpers.YEAR_SECONDS
import com.satirr.commons.helpers.YOUR_ALARM_SOUNDS_MIN_ID
import com.satirr.commons.helpers.ensureBackgroundThread
import com.satirr.commons.helpers.isNougatPlus
import com.satirr.commons.helpers.isOnMainThread
...
import com.satirr.commons.helpers.proPackages
import com.satirr.commons.models.AlarmSound
import com.satirr.commons.models.BlockedNumber
...
import com.satirr.commons.helpers.isPiePlus
...
fun Context.getFilePublicUri(file: File, applicationId: String): Uri {
    ...
    // if media content uri is null, get our custom uri like content://com.satirr.gallery.provider/external_files/emulated/0/DCIM/IMG_20171104_233915.jpg
...
fun Context.isAProApp() = packageName.startsWith("com.satirr.") && packageName.removeSuffix(".debug").endsWith(".pro")

fun Context.addLockedLabelIfNeeded(stringId: Int): String = getString(stringId)
...
fun Context.getCanAppBeUpgraded() = proPackages.contains(baseConfig.appId.removeSuffix(".debug").removePrefix("com.satirr."))
...
fun Context.isDefaultDialer(): Boolean {
    return if (!packageName.startsWith("com.satirr.contacts") && !packageName.startsWith("com.satirr.phone")) {
        true
    } else if ((packageName.startsWith("com.satirr.contacts") || packageName.startsWith("com.satirr.phone")) && isQPlus()) {
...
fun Context.copyToClipboard(text: String) {
    val clip = ClipData.newPlainText(getString(R.string.commons), text)
