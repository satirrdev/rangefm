...
import com.satirr.commons.asynctasks.CopyMoveTask
import com.satirr.commons.dialogs.ConfirmationDialog
import com.satirr.commons.dialogs.ExportSettingsDialog
import com.satirr.commons.dialogs.FileConflictDialog
import com.satirr.commons.dialogs.PermissionRequiredDialog
import com.satirr.commons.dialogs.WritePermissionDialog
import com.satirr.commons.dialogs.WritePermissionDialog.WritePermissionDialogMode
...
import com.satirr.commons.extensions.buildDocumentUriSdk30
import com.satirr.commons.extensions.canManageMedia
import com.satirr.commons.extensions.createAndroidDataOrObbPath
import com.satirr.commons.extensions.createAndroidDataOrObbUri
import com.satirr.commons.extensions.createFirstParentTreeUri
import com.satirr.commons.extensions.deleteFromMediaStore
import com.satirr.commons.extensions.formatSize
import com.satirr.commons.extensions.getAppIconColors
import com.satirr.commons.extensions.getAvailableStorageB
import com.satirr.commons.extensions.getColoredDrawableWithColor
import com.satirr.commons.extensions.getContrastColor
import com.satirr.commons.extensions.getCurrentFormattedDateTime
import com.satirr.commons.extensions.getDoesFilePathExist
import com.satirr.commons.extensions.getFileUrisFromFileDirItems
import com.satirr.commons.extensions.getFirstParentLevel
import com.satirr.commons.extensions.getFirstParentPath
import com.satirr.commons.extensions.getPermissionString
import com.satirr.commons.extensions.getProperBackgroundColor
import com.satirr.commons.extensions.getProperStatusBarColor
import com.satirr.commons.extensions.getThemeId
import com.satirr.commons.extensions.hasAllPermissions
import com.satirr.commons.extensions.hasPermission
import com.satirr.commons.extensions.hideKeyboard
import com.satirr.commons.extensions.humanizePath
import com.satirr.commons.extensions.isAccessibleWithSAFSdk30
import com.satirr.commons.extensions.isAppInstalledOnSDCard
import com.satirr.commons.extensions.isPathOnOTG
import com.satirr.commons.extensions.isPathOnSD
import com.satirr.commons.extensions.isRecycleBinPath
import com.satirr.commons.extensions.isRestrictedSAFOnlyRoot
import com.satirr.commons.extensions.isShowingAndroidSAFDialog
import com.satirr.commons.extensions.isShowingOTGDialog
import com.satirr.commons.extensions.isShowingSAFCreateDocumentDialogSdk30
import com.satirr.commons.extensions.isShowingSAFDialog
import com.satirr.commons.extensions.isShowingSAFDialogSdk30
import com.satirr.commons.extensions.openDeviceSettings
import com.satirr.commons.extensions.openNotificationSettings
import com.satirr.commons.extensions.random
import com.satirr.commons.extensions.showErrorToast
import com.satirr.commons.extensions.storeAndroidTreeUri
import com.satirr.commons.extensions.toast
import com.satirr.commons.extensions.updateOTGPathFromPartition
import com.satirr.commons.extensions.writeLn
import com.satirr.commons.helpers.APP_FAQ
import com.satirr.commons.helpers.APP_ICON_IDS
import com.satirr.commons.helpers.APP_LAUNCHER_NAME
import com.satirr.commons.helpers.APP_LICENSES
import com.satirr.commons.helpers.APP_NAME
import com.satirr.commons.helpers.APP_PACKAGE_NAME
import com.satirr.commons.helpers.APP_REPOSITORY_NAME
import com.satirr.commons.helpers.APP_VERSION_NAME
import com.satirr.commons.helpers.CONFLICT_KEEP_BOTH
import com.satirr.commons.helpers.CONFLICT_SKIP
import com.satirr.commons.helpers.CREATE_DOCUMENT_SDK_30
import com.satirr.commons.helpers.EXTERNAL_STORAGE_PROVIDER_AUTHORITY
import com.satirr.commons.helpers.MEDIUM_ALPHA
import com.satirr.commons.helpers.MyContextWrapper
import com.satirr.commons.helpers.NavigationIcon
import com.satirr.commons.helpers.OPEN_DOCUMENT_TREE_FOR_ANDROID_DATA_OR_OBB
import com.satirr.commons.helpers.OPEN_DOCUMENT_TREE_FOR_SDK_30
import com.satirr.commons.helpers.OPEN_DOCUMENT_TREE_OTG
import com.satirr.commons.helpers.OPEN_DOCUMENT_TREE_SD
import com.satirr.commons.helpers.PERMISSION_POST_NOTIFICATIONS
import com.satirr.commons.helpers.PERMISSION_READ_MEDIA_VISUAL_USER_SELECTED
import com.satirr.commons.helpers.REQUEST_APP_UNLOCK
import com.satirr.commons.helpers.REQUEST_CODE_SET_DEFAULT_CALLER_ID
import com.satirr.commons.helpers.REQUEST_CODE_SET_DEFAULT_DIALER
import com.satirr.commons.helpers.SD_OTG_SHORT
import com.satirr.commons.helpers.SELECT_EXPORT_SETTINGS_FILE_INTENT
import com.satirr.commons.helpers.SHOW_FAQ_BEFORE_MAIL
import com.satirr.commons.helpers.ensureBackgroundThread
import com.satirr.commons.helpers.getConflictResolution
import com.satirr.commons.helpers.isQPlus
import com.satirr.commons.helpers.isRPlus
import com.satirr.commons.helpers.isTiramisuPlus
import com.satirr.commons.helpers.isUpsideDownCakePlus
import com.satirr.commons.helpers.sumByLong
import com.satirr.commons.interfaces.CopyMoveListener
import com.satirr.commons.models.FAQItem
import com.satirr.commons.models.FileDirItem
import com.satirr.commons.views.MyAppBarLayout
import java.io.File
