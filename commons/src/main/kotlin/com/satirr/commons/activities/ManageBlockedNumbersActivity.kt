...
import com.satirr.commons.compose.screens.ManageBlockedNumbersScreen
import com.satirr.commons.compose.theme.AppThemeSurface
import com.satirr.commons.dialogs.AddOrEditBlockedNumberAlertDialog
import com.satirr.commons.dialogs.ExportBlockedNumbersDialog
...
class ManageBlockedNumbersActivity : BaseSimpleActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            val isDialer = remember {
                config.appId.startsWith("com.satirr.phone")
            }
    ...
    private fun maybeSetDefaultCallerIdApp() {
        if (isQPlus() && baseConfig.appId.startsWith("com.satirr.phone")) {
