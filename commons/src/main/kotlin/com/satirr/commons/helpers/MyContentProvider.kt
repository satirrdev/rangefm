...
object MyContentProvider {
    private const val AUTHORITY = "com.satirr.android.provider"
    val MY_CONTENT_URI: Uri = "content://$AUTHORITY/settings".toUri()
    val FONTS_URI: Uri = "content://$AUTHORITY/fonts".toUri()

    const val ACTION_GLOBAL_CONFIG_UPDATED = "com.satirr.android.GLOBAL_CONFIG_UPDATED"
    const val PERMISSION_WRITE_GLOBAL_SETTINGS = "com.satirr.android.permission.WRITE_GLOBAL_SETTINGS"
