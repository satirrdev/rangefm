...
import com.satirr.commons.models.contacts.Address
import com.satirr.commons.models.contacts.Email
import com.satirr.commons.models.contacts.Event
import com.satirr.commons.models.contacts.IM
import com.satirr.commons.models.contacts.PhoneNumberConverter
...
class Converters {
    ...
    fun jsonToAddressList(value: String): ArrayList<Address> {
        ...
        // This is a workaround for https://github.com/satirrdev/rangefm/issues/281
