...
class MyContactsContentProvider {
    companion object {
        private const val AUTHORITY = "com.satirr.commons.contactsprovider"
        ...
        fun getSimpleContacts(context: Context, cursor: Cursor?): ArrayList<SimpleContact> {
            ...
            if (packageName != "com.satirr.phone" && packageName != "com.satirr.messages" && packageName != "com.satirr.calendar") {
                return contacts
            }
