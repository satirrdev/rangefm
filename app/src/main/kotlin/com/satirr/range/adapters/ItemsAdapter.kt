package com.satirr.range.adapters
...
import com.satirr.commons.dialogs.PropertiesDialog
import com.satirr.commons.dialogs.RadioGroupDialog
import com.satirr.commons.dialogs.RenameDialog
import com.satirr.commons.dialogs.RenameItemDialog
import com.satirr.commons.dialogs.RenameItemsDialog
import com.satirr.commons.extensions.applyColorFilter
import com.satirr.commons.extensions.beGone
import com.satirr.commons.extensions.beVisible
import com.satirr.commons.extensions.beVisibleIf
import com.satirr.commons.extensions.convertToBitmap
import com.satirr.commons.extensions.copyToClipboard
import com.satirr.commons.extensions.createDirectorySync
import com.satirr.commons.extensions.deleteFile
import com.satirr.commons.extensions.deleteFileBg
import com.satirr.commons.extensions.deleteFolderBg
import com.satirr.commons.extensions.formatDate
import com.satirr.commons.extensions.formatSize
import com.satirr.commons.extensions.getAndroidSAFFileItems
import com.satirr.commons.extensions.getAndroidSAFUri
import com.satirr.commons.extensions.getColoredDrawableWithColor
import com.satirr.commons.extensions.getDefaultCopyDestinationPath
import com.satirr.commons.extensions.getDocumentFile
import com.satirr.commons.extensions.getDoesFilePathExist
import com.satirr.commons.extensions.getFileCount
import com.satirr.commons.extensions.getFileInputStreamSync
import com.satirr.commons.extensions.getFileOutputStreamSync
import com.satirr.commons.extensions.getFilenameFromPath
import com.satirr.commons.extensions.getIsPathDirectory
import com.satirr.commons.extensions.getMimeType
import com.satirr.commons.extensions.getParentPath
import com.satirr.commons.extensions.getProperSize
import com.satirr.commons.extensions.getTextSize
import com.satirr.commons.extensions.getTimeFormat
import com.satirr.commons.extensions.handleDeletePasswordProtection
import com.satirr.commons.extensions.hasOTGConnected
import com.satirr.commons.extensions.highlightTextPart
import com.satirr.commons.extensions.isPathOnOTG
import com.satirr.commons.extensions.isRestrictedSAFOnlyRoot
import com.satirr.commons.extensions.relativizeWith
import com.satirr.commons.extensions.setupViewBackground
import com.satirr.commons.extensions.showErrorToast
import com.satirr.commons.extensions.toFileDirItem
import com.satirr.commons.extensions.toast
import com.satirr.commons.helpers.CONFLICT_OVERWRITE
...
import com.satirr.commons.helpers.getFilePlaceholderDrawables
...
import com.satirr.range.activities.SplashActivity
import com.satirr.range.databinding.ItemDirGridBinding
import com.satirr.range.databinding.ItemEmptyBinding
import com.satirr.range.databinding.ItemFileDirListBinding
import com.satirr.range.databinding.ItemFileGridBinding
import com.satirr.range.databinding.ItemSectionBinding
import com.satirr.range.dialogs.CompressAsDialog
import com.satirr.range.extensions.config
import com.satirr.range.extensions.isPathOnRoot
import com.satirr.range.extensions.isZipFile
import com.satirr.range.extensions.setAs
import com.satirr.range.extensions.setLastModified
import com.satirr.range.extensions.sharePaths
import com.satirr.range.extensions.toggleItemVisibility
import com.satirr.range.extensions.tryOpenPathIntent
import com.satirr.range.helpers.OPEN_AS_AUDIO
import com.satirr.range.helpers.OPEN_AS_IMAGE
import com.satirr.range.helpers.OPEN_AS_OTHER
import com.satirr.range.helpers.OPEN_AS_TEXT
import com.satirr.range.helpers.OPEN_AS_VIDEO
import com.satirr.range.helpers.RootHelpers
import com.satirr.range.interfaces.ItemOperationsListener
